...
class Settings:
    ...
    def from_env(cls) -> "Settings":
        ...
        return cls(
            ...
            banxico_token=(os.getenv("BANXICO_TOKEN", "").strip().strip('"').strip("'")),
            banxico_series_udis=os.getenv("BANXICO_SERIE_UDIS", "SP68257"),
            banxico_series_inpc=os.getenv("BANXICO_SERIE_INPC", "SP74625"),
            legacy_main_frontend_url=os.getenv("FRONTEND_URL", "https://app.navarroai.com.mx"),
            ...
            correo_relay_from=os.getenv("CORREO_RELAY_FROM", "correo@broquer.app"),
            ...
            meta_app_secret=(os.getenv("META_APP_SECRET", "") or os.getenv("WA_APP_SECRET", "") or os.getenv("FB_APP_SECRET", "")),
            meta_login_config_id=(os.getenv("META_LOGIN_CONFIG_ID", "") or os.getenv("WA_EMBEDDED_SIGNUP_CONFIG_ID", "")),
            ...
            wa2_webhook_url=os.getenv("WA2_WEBHOOK_URL", "https://api.broquer.app/whatsapp2/webhook"),
            wa2_broquer_api_base=os.getenv("BROQUER_API_BASE", "https://api.broquer.app").rstrip("/"),
            ...
            firmame_base_url=os.getenv(
                "FIRMAME_BASE_URL",
                "https://sandbox.firmame.mx/api/v1" if _env_bool("FIRMAME_SANDBOX", default=True)
                else "https://api.firmame.mx/api/v1",
            ).rstrip("/"),
        )
    ...
    def require_correo_secret(self) -> str:
        ...
        if not secret:
            raise RuntimeError("CORREO_SECRET or SUPABASE_SERVICE_KEY is required for email credential encryption")
        return secret
