#!/usr/bin/env python3
"""Route only EasyBroker stats contact-property batch POST through core.database."""
...
def transform_source(source: str) -> str:
    ...
    if old_count == 0 and new_count == 1:
        ...
        return source
    raise RuntimeError(f"Unexpected EB stats link batch POST state: old={old_count}, new={new_count}")
