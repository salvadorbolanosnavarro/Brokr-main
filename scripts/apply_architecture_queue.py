...
STEPS = [
    ...
    Step("rental-docx-safety", "scripts.refactor_main_rental_docx_safety_core"),
    ...
    Step("whatsapp-incoming", "scripts.refactor_whatsapp_extract_incoming_core"),
    Step("whatsapp-delivery-status", "scripts.refactor_whatsapp_extract_delivery_status_core"),
    Step("whatsapp-webhook-change", "scripts.refactor_whatsapp_extract_webhook_change_core"),
...
_TARGET_ATTRS = ("TARGET", "MAIN", "SOURCE", "CONFIG")
