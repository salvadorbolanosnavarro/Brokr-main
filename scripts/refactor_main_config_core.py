...
def transform(source: str) -> str:
    ...
    replacements = [
        ...
        ("os.environ.get('GROQ_API_KEY','')", 'settings.groq_api_key'),
        ...
        ('expected_auth = os.environ.get("REVENUECAT_WEBHOOK_AUTH", "")', 'expected_auth = legacy_main_settings.revenuecat_webhook_auth'),
