...
# Remove the wrapper first, then replace the import using AST-bounded locations.
del lines[wrapper.lineno - 1:wrapper.end_lineno]
# Wrapper is below the import in the current module, so import line numbers are unchanged.
