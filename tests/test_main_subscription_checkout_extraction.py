...
class SubscriptionCheckoutExtractionTests(unittest.TestCase):
    ...
    def test_customer_creation_preserves_fail_soft_local_patch(self):
        r = self.router
        self.assertIn('https://api.stripe.com/v1/customers', r)
        self.assertIn('{"stripe_customer_id": customer_id}', r)
