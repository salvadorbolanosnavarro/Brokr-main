...
async def _buscar_inmuebles(user_id: str, filtros: dict, limit: int = 3) -> tuple[list, bool]:
    ...
    ciudad. Nunca se hace un OR suelto de palabras sin relación entre sí:
    eso es lo que antes hacía que 'Morelia' por sí solo trajera cualquier cosa
    de la ciudad, o que una palabra como 'Olivar' apareciera de casualidad en
    la calle de un inmueble de otro municipio.
    """
