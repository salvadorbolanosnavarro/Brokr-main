...
(function () {
  ...
  const ICONS = {
    ...
    feather:    '<path stroke-linecap="round" stroke-linejoin="round" d="M20.24 12.24a6 6 0 00-8.48-8.48L5 10.5V19h8.5l6.74-6.76z"/><path stroke-linecap="round" stroke-linejoin="round" d="M16 8L2 22m15.5-7H9"/>',
...
`;
  ...
  function buildMainSidebar(items, active) {
    ...
    return items.map(m => buildSidebarLink(m, active) + (m.key === 'blog' ? profileLink : '')).join('');
  }
