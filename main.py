...
# ════════════════════════════════════════════════════════════════════
# AVM — TABLAS REGIONALES DE REFERENCIA (México)
# ════════════════════════════════════════════════════════════════════
# Calibradas con valores AMPI / SHF / Colegios de Valuadores / BIMSA
...
# VRN (valor de reposición nuevo) por m² construido, MXN, residencial 2026
REGIONAL_VRN = {
    "cdmx":               {"lujo": 28000, "bueno": 21000, "medio": 16000, "economico": 11000},
    "ciudad de mexico":   {"lujo": 28000, "bueno": 21000, "medio": 16000, "economico": 11000},
    "monterrey":          {"lujo": 26000, "bueno": 19500, "medio": 15000, "economico": 10000},
    "san pedro garza garcia": {"lujo": 28000, "bueno": 21000, "medio": 16000, "economico": 11000},
    "guadalajara":        {"lujo": 24000, "bueno": 18000, "medio": 13500, "economico":  9500},
    "zapopan":            {"lujo": 25000, "bueno": 18500, "medio": 14000, "economico":  9500},
    "cancun":             {"lujo": 27000, "bueno": 20000, "medio": 15000, "economico": 10500},
    "playa del carmen":   {"lujo": 27000, "bueno": 20000, "medio": 15000, "economico": 10500},
    "tulum":              {"lujo": 29000, "bueno": 22000, "medio": 16000, "economico": 11500},
    "merida":             {"lujo": 22000, "bueno": 16500, "medio": 12500, "economico":  8500},
    "queretaro":          {"lujo": 23000, "bueno": 17000, "medio": 13000, "economico":  9000},
    "san miguel de allende": {"lujo": 28000, "bueno": 22000, "medio": 16000, "economico": 11000},
    "puebla":             {"lujo": 21000, "bueno": 15500, "medio": 11500, "economico":  8500},
    "tijuana":            {"lujo": 24000, "bueno": 18000, "medio": 13500, "economico":  9500},
    "morelia":            {"lujo": 18500, "bueno": 14000, "medio": 11500, "economico":  8500},
    "leon":               {"lujo": 19500, "bueno": 15000, "medio": 11500, "economico":  8500},
    "puerto vallarta":    {"lujo": 26000, "bueno": 19500, "medio": 14500, "economico": 10500},
    "mazatlan":           {"lujo": 22000, "bueno": 16500, "medio": 12500, "economico":  9000},
    "culiacan":           {"lujo": 21000, "bueno": 15500, "medio": 11500, "economico":  8500},
    "hermosillo":         {"lujo": 22000, "bueno": 16500, "medio": 12500, "economico":  9000},
    "aguascalientes":     {"lujo": 20000, "bueno": 15000, "medio": 11500, "economico":  8500},
    "saltillo":           {"lujo": 21000, "bueno": 15500, "medio": 11500, "economico":  8500},
    "chihuahua":          {"lujo": 21000, "bueno": 16000, "medio": 12000, "economico":  8500},
    "veracruz":           {"lujo": 19500, "bueno": 14500, "medio": 11000, "economico":  8000},
    "xalapa":             {"lujo": 19000, "bueno": 14000, "medio": 10500, "economico":  7500},
    "oaxaca":             {"lujo": 18500, "bueno": 14000, "medio": 10500, "economico":  7500},
    "toluca":             {"lujo": 21000, "bueno": 15500, "medio": 12000, "economico":  9000},
    "default":            {"lujo": 19000, "bueno": 14000, "medio": 11000, "economico":  8000},
}

# Cap rate residencial venta (anual). Se ajusta por tipo en _get_cap_rate.
REGIONAL_CAP_RATE = {
    "cdmx":               0.045,
    "ciudad de mexico":   0.045,
    "monterrey":          0.050,
    "guadalajara":        0.050,
    "merida":             0.055,
    "queretaro":          0.055,
    "puebla":             0.060,
    "cancun":             0.065,
    "playa del carmen":   0.070,
    "tulum":              0.075,
    "puerto vallarta":    0.065,
    "san miguel de allende": 0.060,
    "tijuana":            0.060,
    "morelia":            0.055,
    "leon":               0.060,
    "default":            0.060,
...
# Multiplicador de cap rate por tipo de inmueble (mayor = menor valor por ingresos)
CAP_RATE_TIPO_MULT = {
    "casa":         1.00,
    "departamento": 0.95,
    "local":        1.40,
    ...
    "bodega":       1.70,
    "edificio":     1.20,
    "terreno":      1.00,  # no aplica, se neutraliza
}

# Apreciación anual compuesta estimada (referencia SHF / AMPI / SOFTEC 2024-2026)
REGIONAL_APRECIACION = {
    "cdmx":               0.05,
    "ciudad de mexico":   0.05,
    "monterrey":          0.07,
    "san pedro garza garcia": 0.08,
    "guadalajara":        0.07,
    "zapopan":            0.07,
    "merida":             0.09,
    "queretaro":          0.08,
    "san miguel de allende": 0.07,
    "puebla":             0.05,
    "tijuana":            0.06,
    "cancun":             0.07,
    "playa del carmen":   0.07,
    "tulum":              0.08,
    "puerto vallarta":    0.07,
    "mazatlan":           0.06,
    "morelia":            0.04,
    "leon":               0.05,
    "default":            0.05,
...
# Factor listing → precio de cierre (lo que cierra ÷ precio publicado)
# Mercados calientes con poca negociación = más cercano a 1.0
REGIONAL_LISTING_TO_SALE = {
    "cdmx":               0.95,
    "ciudad de mexico":   0.95,
    "monterrey":          0.95,
    "san pedro garza garcia": 0.96,
    "guadalajara":        0.94,
    "merida":             0.96,
    "queretaro":          0.95,
    "san miguel de allende": 0.93,
    "puebla":             0.92,
    "tijuana":            0.93,
    "cancun":             0.93,
    "playa del carmen":   0.93,
    "tulum":              0.92,
    "puerto vallarta":    0.93,
    "morelia":            0.91,
    "leon":               0.92,
    "default":            0.92,
}

# Vida útil estimada por sistema constructivo (años)
VIDA_UTIL_SISTEMA = {
    "concreto":      90,
    "concreto_reforzado": 90,
    "mamposteria":   70,
    "mixto":         75,
    "ligero":        55,
    "madera":        50,
...
# Patrones de colonias premium (plusvalía estructural alta) — heurística por nombre.
# Score base 1.0; los premium suben hasta 1.20; los marginales bajan a 0.85.
PLUSVALIA_PREMIUM_PATTERNS = [
    "polanco", "lomas de chapultepec", "lomas country", "interlomas", "bosques de las lomas",
    "tecamachalco", "santa fe", "del valle norte", "san angel", "pedregal",
    "roma norte", "roma sur", "condesa", "hipodromo", "coyoacan centro", "anzures",
    "san pedro garza", "valle oriente", "carretera nacional", "cumbres elite", "vista hermosa",
    "puerta de hierro", "providencia", "chapalita", "americana", "altavista",
    "campestre", "campo de golf", "club de golf", "country club",
    "altozano", "vistas altozano", "rio altozano",
    "juriquilla", "el campanario", "zibata", "cumbres",
    "san miguel chapultepec", "punta polanco",
    "altabrisa", "san ramon", "montebello", "santa gertrudis", "temozon",
    "puerto cancun", "isla dorada", "puerta del mar",
    "puerto vallarta marina", "amapas", "conchas chinas",
    "san miguel centro", "los frailes",
]
PLUSVALIA_BAJA_PATTERNS = [
    "popular", "ampliacion", "predio", "ejido", "irregular",
    "colonia obrera", "ferrocarril", "tepito",
]

def _get_vrn_regional(ciudad: str, calidad: str) -> int:
    c = _norm_ciudad(ciudad)
    tabla = REGIONAL_VRN.get(c) or REGIONAL_VRN["default"]
    return tabla.get(calidad, tabla.get("medio", 11000))

def _get_cap_rate(ciudad: str, tipo: str) -> float:
    c = _norm_ciudad(ciudad)
    base = REGIONAL_CAP_RATE.get(c, REGIONAL_CAP_RATE["default"])
    mult = CAP_RATE_TIPO_MULT.get((tipo or "").lower(), 1.0)
    return round(base * mult, 4)

def _get_apreciacion(ciudad: str) -> float:
    return REGIONAL_APRECIACION.get(_norm_ciudad(ciudad), REGIONAL_APRECIACION["default"])

def _get_listing_to_sale(ciudad: str) -> float:
    return REGIONAL_LISTING_TO_SALE.get(_norm_ciudad(ciudad), REGIONAL_LISTING_TO_SALE["default"])

def _get_vida_util(sistema: str) -> int:
    return VIDA_UTIL_SISTEMA.get((sistema or "").lower().replace(" ", "_"), VIDA_UTIL_SISTEMA["default"])

def _plusvalia_score(colonia: str, ciudad: str) -> tuple:
    """Devuelve (score 0.85-1.20, etiqueta) basado en heurística por nombre.
    Score >1 = colonia premium; <1 = zona marginal; 1.0 = neutro."""
    if not colonia:
        return 1.0, "neutra"
    nombre = _norm_ciudad(colonia)
    for pat in PLUSVALIA_PREMIUM_PATTERNS:
        if pat in nombre:
            return 1.10, f"premium ({pat})"
    for pat in PLUSVALIA_BAJA_PATTERNS:
        if pat in nombre:
            return 0.90, f"popular ({pat})"
    # Bonus por palabras clave que sugieren zona consolidada
    if any(k in nombre for k in ["residencial", "fraccionamiento", "privada", "country", "real"]):
        return 1.05, "residencial consolidada"
    return 1.0, "neutra"


# ════════════════════════════════════════════════════════════════════
# AVM — HELPERS DE POST-PROCESAMIENTO
# ════════════════════════════════════════════════════════════════════

def _ross_heidecke(edad: float, vida_util: float, conservacion: str) -> float:
    """Factor de demérito Ross-Heidecke combinado (0-1).
    edad: años transcurridos. vida_util: años esperados. conservacion: estado físico."""
    if not vida_util or vida_util <= 0:
        return 1.0
    fc_map = {"excelente": 1.0, "bueno": 0.919, "regular": 0.819, "malo": 0.668}
    fc = fc_map.get((conservacion or "bueno").lower(), 0.919)
    ratio = max(0.0, min(1.0, edad / vida_util))
    base = 1.0 - (ratio ** 1.4)
    return max(0.10, min(1.0, base * fc))

def _filter_iqr_pm2(comps: list, k_lower: float = 1.5, k_upper: float = 1.5) -> tuple:
    """Filtra comparables con $/m² fuera del rango [Q1 - k*IQR, Q3 + k*IQR].
    Devuelve (lista_filtrada, lista_outliers, stats_dict)."""
    valid = [c for c in comps if (c.get("precio_m2") or 0) > 0]
    if len(valid) < 4:
        return valid, [], {"n_original": len(comps), "n_filtrado": len(valid),
                          "metodo": "sin_filtrado_pocos_comps"}
    vals = sorted(c["precio_m2"] for c in valid)
    n = len(vals)
    def _q(p):
        idx = p * (n - 1)
    ...
    iqr = q3 - q1
    lim_inf = q1 - k_lower * iqr
    lim_sup = q3 + k_upper * iqr
    filtrados, outliers = [], []
    for c in valid:
        if lim_inf <= c["precio_m2"] <= lim_sup:
            filtrados.append(c)
        else:
            c_copy = dict(c)
            c_copy["razon_outlier"] = f"${c['precio_m2']:,.0f}/m² fuera de rango IQR [${lim_inf:,.0f}, ${lim_sup:,.0f}]"
            outliers.append(c_copy)
    return filtrados, outliers, {
        "n_original": len(comps), "n_filtrado": len(filtrados),
        "n_outliers": len(outliers),
        "q1": round(q1), "q3": round(q3), "iqr": round(iqr),
        "metodo": "IQR_1.5",
    }

def _peso_similitud(comp: dict, sujeto: dict) -> float:
    """Peso 0.1-1.0 según similitud al sujeto. Atributos comparados:
    superficie relevante, edad, recámaras, fuente confiable, ubicación."""
    peso = 1.0
    sup_sujeto = float(sujeto.get("m2_relevante") or 0)
    sup_comp = float(comp.get("superficie_m2") or 0)
    if sup_sujeto > 0 and sup_comp > 0:
        ratio = min(sup_sujeto, sup_comp) / max(sup_sujeto, sup_comp)
        # ratio 1.0 = idéntico; 0.5 = mitad/doble. Castigamos lineal.
        peso *= 0.4 + 0.6 * ratio
    # Recámaras
    rec_s = int(sujeto.get("recamaras") or 0)
    rec_c = int(comp.get("recamaras") or 0)
    if rec_s > 0 and rec_c > 0:
        diff = abs(rec_s - rec_c)
        peso *= max(0.7, 1.0 - 0.10 * diff)
    # Edad / antigüedad (si el comparable la trae)
    edad_s = float(sujeto.get("edad") or 0)
    edad_c = float(comp.get("edad") or 0)
    if edad_s > 0 and edad_c > 0:
        diff = abs(edad_s - edad_c)
        peso *= max(0.7, 1.0 - 0.015 * diff)
    # Misma colonia (si Claude lo marcó)
    if comp.get("misma_colonia") is True:
        peso *= 1.10
    elif comp.get("misma_colonia") is False:
        peso *= 0.92
    # Marcado explícitamente como "incluir" por Claude
    if comp.get("incluido_en_promedio") is False:
        peso *= 0.6
    return max(0.10, min(1.30, peso))

def _ajuste_temporal_comp(comp: dict, ciudad: str) -> tuple:
    """Si el comparable trae meses_publicado, ajusta su $/m² por apreciación.
    Devuelve (pm2_ajustado, factor_aplicado)."""
    pm2 = float(comp.get("precio_m2") or 0)
    meses = float(comp.get("meses_publicado") or 0)
    if pm2 <= 0 or meses <= 0:
        return pm2, 1.0
    apr_anual = _get_apreciacion(ciudad)
    factor = (1.0 + apr_anual) ** (meses / 12.0)
    return pm2 * factor, factor

def _weighted_mean(values_weights: list) -> float:
    """[(valor, peso), ...] → media ponderada."""
    if not values_weights:
        return 0.0
    total_p = sum(w for _, w in values_weights) or 1.0
    return sum(v * w for v, w in values_weights) / total_p

def _weighted_std(values_weights: list, mean: float) -> float:
    if not values_weights or mean <= 0:
        return 0.0
    total_p = sum(w for _, w in values_weights) or 1.0
    var = sum(w * (v - mean) ** 2 for v, w in values_weights) / total_p
    return var ** 0.5

def _compute_confidence(comps_filtrados: list, comps_originales_n: int,
                       weighted_mean_pm2: float, weighted_std_pm2: float,
                       pesos_promedio: float, fuentes: set) -> dict:
    """Confianza honesta: combina conteo, CV ponderado, similitud y diversidad de fuentes."""
    n = len(comps_filtrados)
    cv = (weighted_std_pm2 / weighted_mean_pm2) if weighted_mean_pm2 > 0 else 1.0
    diversidad = len(fuentes)
    # Score 0-100
    score = 0
    score += min(40, n * 8)                         # 5 comps = 40
    score += max(0, 30 - cv * 100)                  # CV 0% = 30, CV 30%+ = 0
    score += min(15, pesos_promedio * 15)           # similitud promedio
    score += min(15, diversidad * 5)                # 3 fuentes = 15
    nivel = "alta" if score >= 70 else ("media" if score >= 45 else "baja")
    return {
        "nivel": nivel,
        "score": round(score),
        "n_comparables_filtrados": n,
        "n_comparables_originales": comps_originales_n,
        "coef_variacion": round(cv, 3),
        "similitud_promedio": round(pesos_promedio, 3),
        "diversidad_fuentes": diversidad,
        "razon": (
            f"{n} comparables tras filtrado IQR; "
            f"CV={cv*100:.1f}%; similitud={pesos_promedio:.2f}; {diversidad} fuente(s)."
        ),
    }
...
class AvmWebSearchRequest(BaseModel):
    ...
    edad: int = 0
    conservacion: str = "bueno"       # excelente | bueno | regular | malo
    calidad: str = "medio"            # lujo | bueno | medio | economico
    sistema_constructivo: str = ""    # concreto | mamposteria | mixto | madera | adobe
    comentarios: str = ""

@app.post("/api/avm-websearch")
async def avm_websearch(req: AvmWebSearchRequest):
    """Opinión de valor con pipeline en dos etapas:
       (1) Claude busca comparables reales con web_search,
       (2) post-procesamiento determinista: IQR + ponderación por similitud +
           ajuste temporal + listing→cierre + plusvalía + enfoques físico e ingresos."""
    if not ANTHROPIC_API_KEY:
    ...
    # ── Datos regionales ─────────────────────────────────────────────
    vrn_unit          = _get_vrn_regional(req.ciudad, req.calidad)
    cap_rate          = _get_cap_rate(req.ciudad, req.tipo_inmueble)
    apreciacion       = _get_apreciacion(req.ciudad)
    listing_to_sale   = _get_listing_to_sale(req.ciudad)
    plus_score, plus_etq = _plusvalia_score(req.colonia, req.ciudad)
    vida_util         = _get_vida_util(req.sistema_constructivo)

    # ── Descripción del sujeto para Claude ───────────────────────────
    ...
    if req.estacionamientos > 0: partes.append(f"Estacionamientos: {req.estacionamientos}")
    if req.edad > 0: partes.append(f"Edad aproximada: {req.edad} años")
    if req.conservacion: partes.append(f"Estado de conservación: {req.conservacion}")
    if req.calidad: partes.append(f"Calidad de acabados: {req.calidad}")
    if req.sistema_constructivo: partes.append(f"Sistema constructivo: {req.sistema_constructivo}")
    if req.comentarios: partes.append(f"Comentarios: {req.comentarios}")
    descripcion_sujeto = "\n".join(partes)

    # ── Prompt: Claude se enfoca en encontrar datos crudos ricos ─────
    system_prompt = f"""Eres un investigador senior del mercado inmobiliario mexicano. Tu trabajo en este flujo NO es calcular el valor final — eso lo hará un motor matemático determinista de Broquer. Tu trabajo es encontrar los mejores comparables posibles, con metadata rica y honesta, y entregar análisis cualitativo de la zona.

CONTEXTO REGIONAL CALIBRADO (ya inyectado por el sistema, NO lo dupliques en tus cálculos):
- Ciudad: {req.ciudad}
- VRN regional ({req.calidad}): ${vrn_unit:,}/m² construido
- Cap rate aplicable: {cap_rate*100:.2f}%
- Apreciación anual estimada: {apreciacion*100:.1f}%
- Factor listing→cierre: {listing_to_sale:.2f}
- Plusvalía zona ({plus_etq}): {plus_score:.2f}x

PROCESO:

PASO 1 — BÚSQUEDA EXHAUSTIVA
Ejecuta mínimo 4 búsquedas web. Varía los queries:
- "[tipo] en venta [colonia] [ciudad] precio"
- "[tipo] [colonia] [ciudad] lamudi 2025"
- "[tipo] [colonia] [ciudad] vivanuncios"
- "[fraccionamiento o zona] [ciudad] inmuebles24 trovit"
Si la zona tiene submercados (ej: "Vistas Altozano" → "Rio Altozano", "Campo Golf Altozano"), búscalos también.

PASO 2 — EXTRACCIÓN DE COMPARABLES (mínimo 5 ideales, 8-12 óptimo)
Para CADA comparable extrae con honestidad:
- precio (entero MXN, sin comas)
- superficie_m2 (la relevante: terreno si es lote, construcción si tiene casa)
- descripcion (fraccionamiento + features clave en una línea)
- fuente (lamudi/vivanuncios/inmuebles24/propiedades.com/casas.trovit/etc)
- meses_publicado (estimado: si el anuncio dice "publicado hace 3 meses" → 3; si no hay dato → 0)
- misma_colonia (true si está en el mismo fraccionamiento/colonia exacto del sujeto)
- edad_estimada (años, si el anuncio lo menciona; 0 si no)
- recamaras (si aplica al tipo)
- url (opcional, si la puedes citar)
- es_submercado_premium (true si está claramente en una zona más cara que el sujeto, ej: Campo de Golf cuando el sujeto es lote normal)

NO descartes comparables tú mismo por outliers — entrega todo lo que encuentres con datos sólidos. El motor de Broquer hace el filtrado IQR.

PASO 3 — ANÁLISIS CUALITATIVO
- analisis_zona: 2-4 oraciones sobre demanda, plusvalía histórica, perfil del comprador, tendencia.
- plusvalia_cualitativa: 1 (zona en deterioro) a 5 (plusvalía alta sostenida).
- factores_ajuste: lista de 3-6 factores que afectan al sujeto vs los comparables (esquina, topografía, tamaño anormal, vista, ruido, riesgo, etc). Cada factor con porcentaje sugerido (-15 a +15) y justificación.
- recomendaciones: 3-5 puntos accionables para el agente/propietario.
- advertencias: limitaciones honestas de esta opinión.

PASO 4 — ESTIMACIÓN PRELIMINAR (referencial, NO autoritativa)
Como referencia, calcula tu propio promedio crudo:
- precio_m2_crudo_promedio: media aritmética simple de los precio_m2 de los comparables
- valor_estimado_preliminar: precio_m2_crudo_promedio × superficie del sujeto

Este valor servirá como sanity check. El motor de Broquer puede llegar a una cifra distinta tras aplicar IQR, ponderación, ajuste temporal, plusvalía y enfoques múltiples.

FORMATO DE RESPUESTA — responde ÚNICAMENTE con JSON válido (sin markdown, sin texto antes/después):
{{
  "comparables": [
    {{
      "descripcion": "<string>",
      ...
      "precio": <number>,
      "precio_m2": <number — calculado>,
      "fuente": "<string>",
      "meses_publicado": <number 0-36>,
      "misma_colonia": <true|false>,
      "edad_estimada": <number 0-100>,
      "recamaras": <number>,
      "es_submercado_premium": <true|false>,
      "url": "<opcional>"
    }}
  ],
  "factores_ajuste": [
    {{
      "factor": "<string>",
      "descripcion": "<string>",
      "porcentaje": <number -15 a +15>,
      "impacto": "<positivo|negativo|neutro>"
    }}
  ],
  "precio_m2_crudo_promedio": <number entero>,
  "valor_estimado_preliminar": <number entero>,
  "analisis_zona": "<string>",
  "plusvalia_cualitativa": <number 1-5>,
  "resumen_ejecutivo": "<3 oraciones>",
  "recomendaciones": ["<string>", "<string>", "<string>"],
  "advertencias": "<string>",
  "fecha": "<DD/MM/YYYY>"
}}"""

    user_msg = f"""Investiga el mercado y entrega comparables ricos según tu metodología.

INMUEBLE SUJETO:
{descripcion_sujeto}

Ejecuta las búsquedas, recopila comparables con metadata completa, y devuelve únicamente el JSON con la estructura exacta del system prompt."""
    ...
    try:
        ...
        if match:
            try:
                claude_data = json.loads(match.group())
            except Exception:
                raise HTTPException(status_code=502, detail=f"Claude no devolvió JSON válido: {raw[:500]}")
        else:
            raise HTTPException(status_code=502, detail=f"Claude no devolvió JSON válido: {raw[:500]}")
    ...
    superficie_sujeto = float(req.m2_terreno if es_terreno else req.m2_construccion)
    if superficie_sujeto <= 0:
        # Fallback: si por alguna razón no hay superficie, usar la otra disponible
        superficie_sujeto = float(req.m2_construccion or req.m2_terreno or 0)

    comparables_raw = claude_data.get("comparables") or []
    factores_claude = claude_data.get("factores_ajuste") or []

    # 1) Normalización: asegurar precio_m2 calculado
    comps_norm = []
    for c in comparables_raw:
        precio = float(c.get("precio") or 0)
        sup = float(c.get("superficie_m2") or 0)
        if precio <= 0 or sup <= 0:
            continue
        pm2 = float(c.get("precio_m2") or 0)
        if pm2 <= 0:
            pm2 = precio / sup
        comps_norm.append({
            ...
            "precio_m2": int(round(pm2)),
            "fuente": c.get("fuente", ""),
            "meses_publicado": float(c.get("meses_publicado") or 0),
            "misma_colonia": bool(c.get("misma_colonia")) if c.get("misma_colonia") is not None else None,
            "edad": float(c.get("edad_estimada") or 0),
            "recamaras": int(c.get("recamaras") or 0),
            "es_submercado_premium": bool(c.get("es_submercado_premium") or False),
            "url": c.get("url", ""),
    ...
    if not comps_norm:
        raise HTTPException(
            status_code=422,
            detail="No se encontraron comparables válidos con precio y superficie. "
                   "Verifica la colonia/ciudad o intenta con submercados adyacentes."
        )

    # 2) Ajuste temporal por comparable (apreciación regional)
    for c in comps_norm:
        pm2_aj, factor_t = _ajuste_temporal_comp(c, req.ciudad)
        c["precio_m2_temporal"] = int(round(pm2_aj))
        c["factor_temporal"] = round(factor_t, 4)

    # 3) Filtrado IQR sobre precio_m2_temporal
    for c in comps_norm:
        c["precio_m2"] = c["precio_m2_temporal"]  # IQR usa este campo
    comps_filtrados, comps_outliers, iqr_stats = _filter_iqr_pm2(comps_norm)

    # 4) Excluir explícitamente submercados premium si el sujeto NO está en zona premium
    sujeto_es_premium = plus_score >= 1.10
    if not sujeto_es_premium:
        comps_filtrados_paso2 = [c for c in comps_filtrados if not c["es_submercado_premium"]]
        sub_outliers = [{**c, "razon_outlier": "submercado premium (ej. Campo de Golf) excluido"} for c in comps_filtrados if c["es_submercado_premium"]]
        if len(comps_filtrados_paso2) >= 3:
            comps_outliers.extend(sub_outliers)
            comps_filtrados = comps_filtrados_paso2

    if not comps_filtrados:
        # Si IQR fue muy agresivo, restaurar los originales con $/m² más cercano a la mediana
        comps_norm_sorted = sorted(comps_norm, key=lambda x: x["precio_m2_temporal"])
        med = comps_norm_sorted[len(comps_norm_sorted) // 2]["precio_m2_temporal"]
        comps_filtrados = sorted(comps_norm, key=lambda x: abs(x["precio_m2_temporal"] - med))[:5]

    # 5) Aplicar listing→cierre regional a cada comparable filtrado
    for c in comps_filtrados:
        c["precio_m2_cierre"] = int(round(c["precio_m2_temporal"] * listing_to_sale))

    # 6) Ponderación por similitud
    sujeto_calc = {
        "m2_relevante": superficie_sujeto,
        "recamaras": req.recamaras,
        "edad": req.edad,
    }
    pesos = []
    valores_pesos = []
    for c in comps_filtrados:
        w = _peso_similitud(c, sujeto_calc)
        c["peso"] = round(w, 3)
        pesos.append(w)
        valores_pesos.append((c["precio_m2_cierre"], w))

    pm2_mercado = _weighted_mean(valores_pesos)
    pm2_std = _weighted_std(valores_pesos, pm2_mercado)
    pesos_prom = sum(pesos) / len(pesos) if pesos else 1.0

    # 7) Aplicar factores cualitativos de Claude (suma de % con límite ±20%)
    suma_factores_pct = 0.0
    factores_norm = []
    for f in factores_claude:
        try:
            pct = float(f.get("porcentaje") or 0)
        except Exception:
            pct = 0.0
        pct = max(-15, min(15, pct))
        suma_factores_pct += pct
        factores_norm.append({
            "factor": f.get("factor", ""),
            "descripcion": f.get("descripcion", ""),
            "porcentaje": pct,
            "impacto": f.get("impacto", "neutro"),
        })
    suma_factores_pct = max(-20, min(20, suma_factores_pct))

    # 8) Aplicar plusvalía estructural de la zona (heurística por nombre)
    factor_plusvalia = plus_score  # 0.85–1.20

    # 9) Precio/m² final = media ponderada × (1 + factores) × plusvalía
    pm2_final = pm2_mercado * (1 + suma_factores_pct / 100.0) * factor_plusvalia
    pm2_final = round(pm2_final)

    # 10) Enfoque comparativo: valor de mercado
    valor_mercado = pm2_final * superficie_sujeto

    # 11) Enfoque físico (sólo edificaciones)
    enfoque_fisico = None
    if not es_terreno and req.m2_construccion > 0:
        fec = _ross_heidecke(req.edad, vida_util, req.conservacion)
        valor_construccion = vrn_unit * req.m2_construccion * fec
        # Valor del terreno: estimar a partir del residual de los comparables con m2_terreno
        # (usa fórmula: terreno_unit ≈ (precio×listing_to_sale - construcción) / m2_terreno)
        terreno_residuals = []
        for c in comps_filtrados:
            # Asumimos que la superficie reportada es la principal; sólo estimamos si parece tener terreno + construcción
            # Para sujetos con terreno, usamos un ratio simple del 50% del precio total como suelo (heurístico)
            pass
        # Heurístico simple para valor unitario de terreno: 35-50% del VRN unitario aplicado al terreno
        terreno_unit_estimado = vrn_unit * {"lujo": 0.55, "bueno": 0.45, "medio": 0.40, "economico": 0.30}.get(req.calidad, 0.40)
        terreno_unit_estimado *= factor_plusvalia
        valor_terreno = terreno_unit_estimado * float(req.m2_terreno) if req.m2_terreno > 0 else 0
        valor_fisico_total = valor_construccion + valor_terreno
        enfoque_fisico = {
            "vrn_unitario": vrn_unit,
            "vida_util": vida_util,
            "fec_ross_heidecke": round(fec, 3),
            "valor_construccion": int(round(valor_construccion)),
            "valor_terreno_unitario": int(round(terreno_unit_estimado)),
            "valor_terreno": int(round(valor_terreno)),
            "valor_fisico_total": int(round(valor_fisico_total)),
        }

    # 12) Enfoque de capitalización (sólo edificaciones con renta plausible)
    enfoque_ingresos = None
    if not es_terreno and req.m2_construccion > 0 and cap_rate > 0:
        # Renta mensual estimada por relación renta/valor ≈ cap_rate/12 sobre valor_mercado
        renta_mensual_implicita = (valor_mercado * cap_rate) / 12.0
        valor_capitalizacion = (renta_mensual_implicita * 12.0) / cap_rate  # auto-consistente; sirve cuando renta es exógena
        # Para una estimación independiente, asumimos renta de mercado ≈ 0.55% del valor mercado/mes
        renta_estimada_market = valor_mercado * 0.0055
        valor_capitalizacion_independiente = (renta_estimada_market * 12.0 * 0.86) / cap_rate  # 86% efectiva (vacancia+gastos)
        enfoque_ingresos = {
            "cap_rate": round(cap_rate, 4),
            "renta_mensual_estimada": int(round(renta_estimada_market)),
            "renta_anual_efectiva": int(round(renta_estimada_market * 12 * 0.86)),
            "valor_capitalizacion": int(round(valor_capitalizacion_independiente)),
        }

    # 13) Conciliación: valor final = ponderado entre enfoques cuando aplique
    if es_terreno:
        valor_final = valor_mercado
        conciliacion_pesos = {"comparativo": 1.0, "fisico": 0.0, "ingresos": 0.0}
    elif enfoque_fisico and enfoque_ingresos:
        # Residencial completo: comparativo 65%, físico 25%, ingresos 10%
        valor_final = (valor_mercado * 0.65
                       + enfoque_fisico["valor_fisico_total"] * 0.25
                       + enfoque_ingresos["valor_capitalizacion"] * 0.10)
        conciliacion_pesos = {"comparativo": 0.65, "fisico": 0.25, "ingresos": 0.10}
    elif enfoque_fisico:
        valor_final = valor_mercado * 0.75 + enfoque_fisico["valor_fisico_total"] * 0.25
        conciliacion_pesos = {"comparativo": 0.75, "fisico": 0.25, "ingresos": 0.0}
    else:
        valor_final = valor_mercado
        conciliacion_pesos = {"comparativo": 1.0, "fisico": 0.0, "ingresos": 0.0}

    valor_final = int(round(valor_final / 1000.0)) * 1000  # redondeo al millar

    # 14) Rango: usar desviación ponderada del comparativo (más honesto que ±8% fijo)
    if pm2_mercado > 0 and pm2_std > 0:
        cv_local = min(0.12, pm2_std / pm2_mercado)  # tope 12% para evitar rangos absurdos
        rango_pct = max(0.05, cv_local)              # mínimo ±5%
    else:
        rango_pct = 0.07
    valor_min = int(round(valor_final * (1 - rango_pct) / 1000.0)) * 1000
    valor_max = int(round(valor_final * (1 + rango_pct) / 1000.0)) * 1000

    # 15) Confianza estructurada
    fuentes_set = {c.get("fuente", "").lower() for c in comps_filtrados if c.get("fuente")}
    confianza = _compute_confidence(
        comps_filtrados, len(comps_norm), pm2_mercado, pm2_std, pesos_prom, fuentes_set,
    )

    # ════════════════════════════════════════════════════════════════
    # RESPUESTA — preservar schema original + agregar nuevos campos
    # ════════════════════════════════════════════════════════════════

    # Agregar factores macro a la lista de factores_ajuste para mostrarlos al usuario
    factores_macro = []
    if abs(listing_to_sale - 1.0) > 0.001:
        pct_lts = round((listing_to_sale - 1.0) * 100, 1)
        factores_macro.append({
            "factor": "Listing → precio de cierre",
            "descripcion": f"En {req.ciudad}, los precios cierran a {listing_to_sale:.2f}× el publicado (margen de negociación promedio).",
            "porcentaje": pct_lts,
            "impacto": "negativo" if pct_lts < 0 else "neutro",
        })
    if abs(plus_score - 1.0) > 0.001:
        pct_plus = round((plus_score - 1.0) * 100, 1)
        factores_macro.append({
            "factor": f"Plusvalía estructural de la zona ({plus_etq})",
            "descripcion": f"Ajuste por perfil de plusvalía detectado en '{req.colonia}'.",
            "porcentaje": pct_plus,
            "impacto": "positivo" if pct_plus > 0 else ("negativo" if pct_plus < 0 else "neutro"),
        })
    if apreciacion > 0 and any(c.get("meses_publicado", 0) > 0 for c in comps_filtrados):
        factores_macro.append({
            "factor": "Ajuste temporal por apreciación regional",
            "descripcion": f"Comparables publicados con anterioridad se traen al presente a {apreciacion*100:.1f}% anual.",
            "porcentaje": 0,  # ya incorporado en precio_m2_temporal
            "impacto": "neutro",
        })

    factores_finales = factores_macro + factores_norm

    resultado = {
        # ── Campos legacy (compatibilidad con frontend actual) ──
        "valor_estimado": valor_final,
        "valor_minimo": valor_min,
        "valor_maximo": valor_max,
        "valor_por_m2": pm2_final,
        "precio_m2_base": int(round(pm2_mercado)),
        "nivel_confianza": confianza["nivel"],
        "razon_confianza": confianza["razon"],
        "resumen_ejecutivo": claude_data.get("resumen_ejecutivo", ""),
        "comparables": [
            {
                "descripcion": c["descripcion"],
                "superficie_m2": c["superficie_m2"],
                "precio": c["precio"],
                "precio_m2": c["precio_m2_cierre"],
                "precio_m2_original": int(round(c["precio_m2"] / max(c["factor_temporal"], 0.0001))) if c.get("factor_temporal", 1.0) != 1.0 else c["precio_m2"],
                "fuente": c["fuente"],
                "peso_similitud": c["peso"],
                "meses_publicado": c["meses_publicado"],
        ...
        "factores_ajuste": factores_finales,
        "precio_m2_ajustado_calculo": (
            f"Media ponderada $/m² ${int(round(pm2_mercado)):,} × "
            f"(1 {'+' if suma_factores_pct >= 0 else ''}{suma_factores_pct:.1f}%) × "
            f"plusvalía {factor_plusvalia:.2f} = ${pm2_final:,}/m²"
        ),
        "analisis_zona": claude_data.get("analisis_zona", ""),
        "recomendaciones": claude_data.get("recomendaciones", []),
        "advertencias": claude_data.get("advertencias", ""),
        "fecha": claude_data.get("fecha", time.strftime("%d/%m/%Y")),

        # ── Nuevos campos del pipeline ──────────────────────────────
        "confianza_detalle": confianza,
        "ajustes_macro": {
            "listing_to_sale_factor": round(listing_to_sale, 3),
            "apreciacion_anual": round(apreciacion, 3),
            "plusvalia_zona": {"score": round(plus_score, 3), "etiqueta": plus_etq},
            "vrn_regional_unitario": vrn_unit,
            "cap_rate_aplicado": round(cap_rate, 4),
            "ciudad_normalizada": _norm_ciudad(req.ciudad),
        },
        "enfoque_comparativo": {
            "precio_m2_media_ponderada": int(round(pm2_mercado)),
            "precio_m2_desviacion": int(round(pm2_std)),
            "coef_variacion": round(pm2_std / pm2_mercado, 4) if pm2_mercado > 0 else 0,
            "valor_mercado": int(round(valor_mercado / 1000)) * 1000,
        },
        "enfoque_fisico": enfoque_fisico,
        "enfoque_ingresos": enfoque_ingresos,
        "conciliacion": {
            "pesos": conciliacion_pesos,
            "metodo": "comparativo+fisico+ingresos" if (enfoque_fisico and enfoque_ingresos) else
                      ("comparativo+fisico" if enfoque_fisico else "comparativo"),
        },
        "iqr_filtrado": iqr_stats,
        "comparables_excluidos": [
            {
                "descripcion": c.get("descripcion", ""),
                "precio": c.get("precio", 0),
                "superficie_m2": c.get("superficie_m2", 0),
                "precio_m2": c.get("precio_m2", 0),
                "fuente": c.get("fuente", ""),
                "razon_outlier": c.get("razon_outlier", ""),
            }
            for c in comps_outliers
        ],
        "valor_preliminar_claude": claude_data.get("valor_estimado_preliminar", 0),
        "precio_m2_crudo_claude": claude_data.get("precio_m2_crudo_promedio", 0),
        ...
        "banos": req.banos,
        "edad": req.edad,
        "conservacion": req.conservacion,
        "calidad": req.calidad,
        "sistema_constructivo": req.sistema_constructivo,
        "condicion_terreno": req.condicion_terreno,
        "timestamp": time.strftime("%Y-%m-%d %H:%M"),
    }
